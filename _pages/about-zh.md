...
<br>
<blockquote>
  <p><strong>📢 招生信息:</strong> 目前正在招收软件工程专业三名2027级硕士研究生，一名2027级博士研究生。如果您对我的研究方向感兴趣，欢迎将个人简历发送至我的邮箱：<a href="mailto:gaoyucen@neu.edu.cn">gaoyucen@neu.edu.cn</a>.</p>
</blockquote>

<span class='anchor' id='news'></span>
# 🔥 新闻

- [2026.09] 一篇关于去中心化多目标多智能体路径规划的论文被 **NeurIPS 2026** 接收（通讯作者）。
- [2026.08] 一篇关于利用大模型进行养老金精算的论文被 **ICDM 2026** 接收（通讯作者）。
- [2026.08] 一篇关于利用大模型进行路径规划的论文被 **WISE 2026** 接收（指导学生一作）。
- [进行中] 担任 **DASFAA 2027** 的**Web Chair**。
...
<!--B一作及通讯7-->
11. [CCF-B] Haitao Zhou, Zhenfeng Yang, Jinpeng Deng, Xinyu Zhuang, Ming Jiang, **Yucen Gao**\*, A Deployed LLM-Based System for Urban Employee Pension Fund Actuarial Analysis, IEEE International Conference on Data Mining (ICDM), 2026. (通讯作者)
12. [CCF-B] Pengfei Du, **Yucen Gao**\*, Xiaochun Yang, Bin Wang, PID-Controlled Constrained RL for Hub-based Joint Pricing, Dispatching, and Routing with Service Guarantees, International Joint Conference on Artificial Intelligence (IJCAI), 2026. (通讯作者)
...
<!--C以下一作3-->
26. [CCF-C] **Yucen Gao**, Dejun Kong, Haipeng Dai, Xiaofeng Gao, Jiaqi Zheng, Fan Wu, Guihai Chen, DE-DQN: A Dual-Embedding Based Deep Q-Network for Task Assignment Problem in Spatial Crowdsourcing, APWeb-WAIM International Joint Conference on Web and Big Data (APWeb-WAIM), 2022. (最佳论文奖)
...
# 🧰 科研项目
- 国家自然科学基金青年基金（C类），城市复杂风场环境下多无人机协同路径规划研究，2027.01-2029.12，主持
