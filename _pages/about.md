...
<br>
<blockquote>
  <p><strong>📢 Recruitment:</strong> I am recruiting two 2026 Master's students, three 2027 Master's students, and one 2027 Ph.D. student in Software Engineering. If you are interested in my research, please feel free to send your CV to my email at <a href="mailto:gaoyucen@neu.edu.cn">gaoyucen@neu.edu.cn</a>.</p>
</blockquote>
...
<!--A合作4-->
7. [CCF-A] Xuening Wang, Bin Wang, Xiaochun Yang, Sihui Li, **Yucen Gao**\*, Decentralized Multi-Goal Multi-Agent Pathfinding with Spatial Prior and Neighbor Intent Prediction, Conference on Neural Information Processing Systems (NeurIPS), 2026. (Corresponding Author)
...
# 🧰 Projects
- National Natural Science Foundation of China Young Scientists Fund (Category C), Research on Cooperative Path Planning for Multiple UAVs in Complex Urban Wind Field Environments, 2027.01-2029.12, Principal Investigator
